...
get.data<-function(csv,atlas,antsdir="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/",pipedir="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/",pipedate){

     gfl4<-load.csv(csv)
     print(names(gfl3))
#      gfl4<-ants.vols(gfl=gfl4,atlas=atlas,antsdir=antsdir,pipedate=pipedate)
     gfl4<-add.minctracc.vols(gfl=gfl4,atlas=atlas,pipedir=antsdir,pipedate=pipedate)
     return(gfl4)
}
 get.data(csv="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/taxibus-analysis/csv-files/image-mouse-day-spreadsheet-30jul10.csv",atlas="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/atlas-transform/atlas-15jul10-nlin5.mnc",antsdir="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/",pipedate="15jul10")
...
gfl2<-load.csv
 ...
 gfl2<-ants.vols(gfl=gfl2,atlas="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/atlas-transform/atlas-15jul10-nlin5.mnc",antsdir="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/",pipedate="15jul10")


 gfl3<-add.minctracc.vols(gfl=gfl2,atlas="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/atlas-transform/atlas-15jul10-nlin5.mnc",pipedir="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/",pipedate="15jul10")
...
gfl<-load.csv("/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/taxibus-analysis/csv-files/image-mouse-day-spreadsheet-15jul10.csv")
gfl<-ants.vols(gfl=gfl,atlas="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/atlas-transform/atlas-15jul10-nlin5.mnc", antsdir="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/",pipedate="15jul10")

gfl<-add.minctracc.vols(gfl=gfl,atlas="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/atlas-transform/atlas-15jul10-nlin5.mnc",pipedir="/projects/souris/psteadman/in-vivo-buildmodel/in-vivo-plbase/",pipedate="15jul10")
return(gfl)
}
